...
//    }
    // 创建一个集合保存输入和输出目录
//    val Array(inputPath,outputPath) = Array("dir/2016-10-01_06_p1_invalid.1475274123982.log","D:\\data\res")
    ...
    // 进行数据的读取，处理分析数据
    val lines = sc.textFile("dir/2016-10-01_06_p1_invalid.1475274123982.log")
